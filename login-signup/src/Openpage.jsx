...
const Openpage = () => {
  return (
    <div className='text-center h-[100dvh] w-[100dvw] bg-gradient-to-bl from-[#123458] to-[#d4c9be] flex flex-col gap-3 justify-center items-center text-[#030303] '>
      ...
      <h1 className='text-3xl font-bold sm:text-6xl md:text-5xl lg:text-6xl'>Hello, Friend!</h1>
      <p className='text-2xl sm:text-2xl md:text-2xl'>Enter your personal details and start journey with us</p>
